...
**Components** are the basic building blocks you use in LlamaIndex. These include things like prompts, models and databases. Components often help connect LlamaIndex with other tools and libraries. For
...
**Workflows** are step-by-step processes that processing logic together. Workflows or agentic workflows are a way to structure agentic behaviour.
