...
![Hình ảnh minh họa Chương Thêm 1](https://huggingface.co/datasets/agents-course/course-images/resolve/main/en/bonus-unit1/thumbnail.jpg)

Chào mừng bạn đến với **Chương Thêm đầu tiên** này, nơi ta sẽ học cách **tinh chỉnh (fine-tuning) Mô hình Ngôn ngữ Lớn (LLM) cho function calling**.
...
> **Khi nào nên học Chương Thêm này?**
>
...
>  
> Đừng lo, Chương Thêm được thiết kế để cung cấp đầy đủ thông tin cần thiết. Chúng mình sẽ hướng dẫn bạn từng khái niệm cốt lõi về tinh chỉnh model cho function calling dù bạn chưa hiểu sâu về fine-tuning.

Để học tốt Chương Thêm này, bạn cần:
...
Kết thúc Chương Thêm này, bạn sẽ có thể:
