...
- Khám phá **syllabus của khóa học**.
...
## Syllabus khóa học [[syllabus]]

Đây là **syllabus tổng quan**. Danh sách chi tiết sẽ được cập nhật cùng mỗi Chương.
...
| 1.5 | Thêm: Fine-tuning LLM cho function calling | Sử dụng LoRa và fine-tune model để thực hiện function calling trong notebook |
...
- [Theo dõi Joffrey trên Hugging Face](https://huggingface.co/Jofthomas)
- [Theo dõi Joffrey trên X](https://x.com/Jthmas404)
- [Theo dõi Joffrey trên Linkedin](https://www.linkedin.com/in/joffrey-thomas/)
...
- [Theo dõi Ben trên Hugging Face](https://huggingface.co/burtenshaw)
- [Theo dõi Ben trên X](https://x.com/ben_burtenshaw)
- [Theo dõi Ben trên Linkedin](https://www.linkedin.com/in/ben-burtenshaw/)
...
- [Theo dõi Thomas trên Hugging Face](https://huggingface.co/ThomasSimonini)
- [Theo dõi Thomas trên X](https://x.com/ThomasSimonini)
- [Theo dõi Thomas trên Linkedin](https://www.linkedin.com/in/simoninithomas/)
...
Đã có đủ thông tin, hãy cùng lên tàu ⛵ 
