...
### Bước 3: Theo dõi Tổ chức Khóa học Hugging Face Agent

Cập nhật tài liệu, thông tin mới nhất và thông báo **bằng cách theo dõi Tổ chức Khóa học Hugging Face Agent**.
...
1. Thể hiện sự ủng hộ bằng cách ⭐ <a href="https://github.com/huggingface/agents-course" target="_blank">kho lưu trữ của khóa học</a>.
