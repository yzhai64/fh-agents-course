# Live 1: Cách thức hoạt động của Khóa học và Buổi Hỏi và Đáp đầu tiên

Trong buổi Live đầu tiên của Khóa học Agents, chúng mình đã giải thích cách thức **hoạt động** của khóa học (phạm vi, các Chương, bài tập lớn, v.v.) và trả lời các câu hỏi từ các bạn.
