...
Before fulfilling the order, Alfred engages in reasoning and planning.
...
Once he has a plan in mind, Alfred must act. To execute his plan, he needs to use tools. In this case, to make a coffee, he uses a coffee machine. He activates the coffee machine to brew the coffee.
