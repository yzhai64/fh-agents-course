...
Now that we understand what Agents are, let's take a short, ungraded quiz to reinforce our knowledge. After that, we'll dive deeper into the "Agent's brain": the [LLMs](what-are-llms).
