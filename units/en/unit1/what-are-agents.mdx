...
Well known examples are **GPT4** from **OpenAI**, **LLama** from **meta**, **Gemini** from **Google**, etc. Those models have been trained on a vast amount of text and are able to generalize well. We will learn more about LLMs in the next section.
