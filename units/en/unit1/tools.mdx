...
Tools exist in order to enhance the capabilities of the LLM and to accomplish a wider range of tasks. We'll see in this section how AI Tools can be integrated into Agents.
...
--
We just learned, that AI Tools play a crucial role in enhancing the capabilities of AI agents. 
...
Now that we know how tools extend an LLM’s functionality, we’ll move on to the Agent Workflow. 

There, you’ll see how an Agent observes, thinks, and acts—bringing together everything we’ve covered so far and setting the stage for creating your own fully functional AI Agent.
