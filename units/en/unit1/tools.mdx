...
If you want to provide additional tools, you have to be consistent and always use the same format. The process can be fragile and LLMs may forget some details.
