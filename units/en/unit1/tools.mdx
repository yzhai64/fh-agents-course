...
- A Tool should contain:
  ...
  - (Optionnal) Outputs with typings.

## How do we give tools to an LLM ?

The answer might be a bit underwhelming, but we simply provide textual descriptions of all the tools available for the model to use in the system prompt.
...
<details>
<summary>decorator code ( advanced )</summary>
_For those interested, here’s the code to declare a Tool using a decorator._
```python
def tool(func):
    """
