...
Since you interact with Agents through a chat interface, it’s important to study the underlying Message System that tranforms user inputs and system instructions into a coherent prompt.
...
<figcaption>We see here the difference between what we see in UI and the prompt.
</figcaption>
</figure>
