...
<INSERT Illustration of huggingchat and the same conversation as prompt>
...
In Agents, the system prompt allows to store the information about available tools, provide instructions to the model on how to format the actions to take, and guide the overall guidelines of how the thought process should be segmented.
