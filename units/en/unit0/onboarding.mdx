...
- `#smolagents`: where you can discuss and get support with the smolagents library.

<!-- Study groups? -->

If this is your first time using Discord, we wrote a Discord 101 to get the best practices. Check [the next section](03_discord101).
