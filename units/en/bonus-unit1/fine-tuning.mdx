...
2. To be useful in a chat context, the model needs to be **fine-tuned** to follow instructions. In this step, it can be trained by the model creators, open-source community, you, or anyone. For instance, [google/gemma-2-2b-it](https://huggingface.co/google/gemma-2-2b-it) is an instruct-tuned model by the Google Team behind the Gemma project.
