...
Usually, a complete product like Gemini or Mistral **will go through all 3 steps**, while the models you can find on Hugging Face have passed through one or more steps of this training.

In this tutorial, we will build a function-calling model based on [google/gemma-2-2b-it](https://huggingface.co/google/gemma-2-2b-it). The base model is [google/gemma-2-2b](https://huggingface.co/google/gemma-2-2b), and the Google team fine-tuned the base model for instruction following, resulting in **"google/gemma-2-2b-it"**.

In this case, we will take **"google/gemma-2-2b-it"** as the base and **not the base model because the prior fine-tuning it has undergone is important for our use case**.

Since we want to interact with our model through conversations in messages, starting from the base model **would require more training to learn instruction following, chat, AND function-calling**.
