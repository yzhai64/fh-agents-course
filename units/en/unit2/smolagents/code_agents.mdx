<CourseFloatingBanner chapter={2}
  ...
  notebooks={[
    {label: "Google Colab", value: "https://colab.research.google.com/github/huggingface/agents-course/blob/main/notebooks/unit2/smolagents/smolagents_code_agents.ipynb"},
]} />

# Building Agents That Use Code

Code agents are the default agent type in `smolagents`. They generate Python tool calls directly to perform actions, making them both efficient and accurate. 
...
<img src="https://huggingface.co/datasets/agents-course/course-images/resolve/main/en/unit2/smolagents/alfred-process.jpg" alt="Alfred Process"/>
