...
**Defining a clear set of Tools is crucial to performance.** As we discussed in [unit 1](../../unit1/tools.mdx), clear tool interfaces are easier for LLMs to use.
...
![Tools](https://huggingface.co/datasets/agents-course/course-images/resolve/main/en/unit2/tools.png)
...
<Tip>When using an agent or LLM with function calling, the tool selected (and the arguments written for that tool) rely strongly on the tool name and description of the tools purpose and arguments.</Tip>
...
<Tip>You can find toolspecs and utility tools on the [LlamaHub](https://llamahub.ai/)</Tip>
