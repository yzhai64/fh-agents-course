...
![Workflow Schematic](https://huggingface.co/datasets/agents-course/course-images/resolve/main/en/unit2/workflows.png)
...
<Tip>There are some more complex nuances to workflows, which you can learn about in [the LlamaIndex documentation](https://docs.llamaindex.ai/en/stable/understanding/workflows/).</Tip>
